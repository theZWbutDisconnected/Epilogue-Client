...
public class Xray extends Module {
    ...
    public final BooleanValue cavesOnly = new BooleanValue("CavesOnly", true);
    public final IntValue caveRadius = new IntValue("CavesRadius", 2, 1, 2);
    public final BooleanValue diamonds = new BooleanValue("Diamonds", true);
    public final BooleanValue diamondTracers = new BooleanValue("DiamondsTracers", true);
    public final BooleanValue gold = new BooleanValue("Gold", true);
    public final BooleanValue goldTracers = new BooleanValue("GoldTracers", true);
    public final BooleanValue iron = new BooleanValue("Iron", false);
    public final BooleanValue ironTracers = new BooleanValue("IronTracers", false);
    public final BooleanValue coal = new BooleanValue("Coal", false);
    public final BooleanValue coalTracers = new BooleanValue("CoalTracers", false);
    public final BooleanValue redstone = new BooleanValue("Redstone", false);
    public final BooleanValue redStoneTracers = new BooleanValue("RedstoneTracers", false);
    public final BooleanValue lapis = new BooleanValue("Lapis", false);
    public final BooleanValue lapisTracers = new BooleanValue("LapisTracers", false);
    public final BooleanValue emeralds = new BooleanValue("Emeralds", false);
    public final BooleanValue emeraldsTracers = new BooleanValue("EmeraldsTracers", false);
    public final BooleanValue spawners = new BooleanValue("Spawners", false);
    public final BooleanValue spawnerTracers = new BooleanValue("SpawnersTracers", false);
    public final BooleanValue canes = new BooleanValue("Canes", false);
    public final BooleanValue canesTracers = new BooleanValue("CanesTracers", false);
    public final BooleanValue warts = new BooleanValue("Warts", false);
    public final BooleanValue wartsTracers = new BooleanValue("WartsTracers", false);
