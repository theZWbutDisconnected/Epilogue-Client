...
public class Velocity extends Module {
    ...
    public final PercentValue horizontal = new PercentValue("Velocity Horizontal", 100);
    public final PercentValue vertical = new PercentValue("Velocity Vertical", 100);
    ...
    public final BooleanValue debugLog = new BooleanValue("Debug", true);
    public final IntValue delayTicks = new IntValue("Delay Ticks", 1, 1, 20, () -> this.mode.getValue() == 2);
    public final PercentValue delayChance = new PercentValue("Velocity Chance", 100, () -> this.mode.getValue() == 2);
